...
export default function RevenueManagement() {
  ...
  function StoreRevenueSummary({ storeRevenues, formatCurrency }: { 
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                            ...
                            <div className="flex space-x-6 text-sm">
                              ...
                              <div className="text-center">
                                ...
                                <p className="font-bold text-blue-600">{formatCurrency(storeRevenue.topCouponUser.totalCouponDiscount)}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                                ...
                                <div className="text-right">
                                  ...
                                  {revenue.coupon && (
                                    <p className="text-xs text-orange-600">
                                      Mã: {revenue.coupon.code} (-{formatCurrency(revenue.discountAmount || 0)})
                                    </p>
                                  )}
                                </div>
                              </div>
                      ...
                      <div className="flex flex-col">
                        ...
                        {revenue.originalAmount && revenue.originalAmount !== revenue.amount && (
                          <div className="text-xs text-gray-500 line-through">
                            {formatCurrency(revenue.originalAmount)}
                          </div>
                        )}
                      </div>
                    </td>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-6">
            ...
            <div className="bg-gradient-to-r from-green-400 to-green-600 p-6 rounded-lg shadow-lg text-white">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl lg:text-3xl font-bold">{formatCurrency(stats.totalRevenue)}</p>
                </div>
            ...
            <div className="bg-gradient-to-r from-orange-400 to-orange-600 p-6 rounded-lg shadow-lg text-white">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl lg:text-3xl font-bold">{formatCurrency(stats.totalDiscount)}</p>
                </div>
        ...
        {viewMode === 'summary' ? (
          <StoreRevenueSummary storeRevenues={storeRevenues} formatCurrency={formatCurrency} />
        ) : (
          <DetailedRevenueTable revenues={revenues} formatCurrency={formatCurrency} pagination={pagination} handlePageChange={handlePageChange} />
        )}
      </div>
    </div>
  );
